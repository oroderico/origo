 ...
 * lines' 25px) to fit a fourth: a numbered word list reads one word per line,
 * so 12 or 24 words comes out to a clean 3 or 6 pages this way instead of the
 * 4 or 8 three lines would need. Still clears the footer with room to spare
 * at the same 16px face - the four lines run title+23 to title+23+3*20+16,
 * i.e. y=28 to 108, three pixels shy of the footer at 111. */
